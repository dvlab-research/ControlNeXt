...
class UNetSpatioTemporalConditionControlNeXtModel(ModelMixin, ConfigMixin, UNet2DConditionLoadersMixin):
    ...
    def forward(
        ...
        mid_block_additional_residual = F.adaptive_avg_pool2d(mid_block_additional_residual, sample.shape[-2:])
        sample = sample + mid_block_additional_residual * torch.sigmoid(scale)*1.3 
